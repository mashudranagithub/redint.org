...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Presentation file Re-upload</li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-lg-12 col-xs-12">
      <form role="form" action="{{ route('update-presentation', $presentation->id) }}" method="post" enctype="multipart/form-data">
        <input type="hidden" name="_method" value="PUT">
          {{ csrf_field() }}
        <div class="box-body">
          <h2>Presentation Re-Upload Form</h2>
          <hr>
        ...
        <div class="box-footer">
          <button type="submit" class="btn btn-primary">Re-upload Presentation</button>
        </div>
      </form>
    </div>
  </div>
